...
public class Register extends AppCompatActivity {
    ...
    // объявить переменную для страницы регистрации
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // добавление поля для пользовательского ввода
    ...
    // проверка электронной почты, пароля, имени и длины номера мобильного телефона
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(res -> {
                if (res.isSuccessful()) {
                    if (dialog != null && dialog.isShowing()) {
                        dialog.dismiss(); // закрыть диалоговое окно, если оно привязано к окну
                    }
